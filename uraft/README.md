## This is URA FT (NEAR) repository which is forked from [NEAR](https://gitpod.io/#https://github.com/near-examples/FT) and has been modified accordingly.

Fungible Token (FT)
===================

URAFT experiment [Fungible Token] contract which uses [near-contract-standards] and [simulation] tests.
