## This is URA NFT (NEAR) repository which is forked from [NEAR](https://gitpod.io/#https://github.com/near-examples/NFT) and has been modified accordingly.
...
URANFT experiment [non-fungible token] contract which uses [near-contract-standards] and [simulation] tests.
